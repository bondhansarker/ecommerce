...
type Config struct {
	...
	DBPostgreDriver string `mapstructure:"DB_POSTGRES_DRIVER"`
	DBPostgreDsn    string `mapstructure:"DB_POSTGRES_DSN"`
	DBPostgreURL    string `mapstructure:"DB_POSTGRES_URL"`
}
